...
int init_heat() {
    ...
    if (T_RECFAST(100, 1) < 0) return -4;
    if (xion_RECFAST(100, 1) < 0) return -5;
    if (spectral_emissivity(0, 1, 2) < 0) return -6;
    if (kappa_10_elec(1.0, 1) < 0) return -2;
...
// approximation for the adiabatic index at z=6-50 from 2302.08506 (also 1506.04152). Linear only,
// used to initialize the Tk box at high z so it's not homogeneous. Otherwise half of the adiabatic
// fluctuations are missing. Definition is \delta Tk = Tk * cT * \delta (at each z).
float cT_approx(float z) { return 0.58 - 0.006 * (z - 10.0); }
...
// * Reads in and constructs table of the piecewise power-law fits to Pop 2 and Pop 3 stellar
// spectra, from Barkana * //
...
double kappa_10(double TK, int flag) {
    ...
    if (flag == 1) {
        ...
        tkin_spline[0] = 0.0;
        kap_spline[0] = -29.6115227098;
        tkin_spline[1] = 0.317597943861;
        kap_spline[1] = -29.6228184691;
        tkin_spline[2] = 0.635195887722;
        kap_spline[2] = -29.5917673123;
        tkin_spline[3] = 0.952793831584;
        kap_spline[3] = -29.4469989515;
        tkin_spline[4] = 1.27039177544;
        kap_spline[4] = -29.1171430989;
        tkin_spline[5] = 1.58798971931;
        kap_spline[5] = -28.5382192456;
        tkin_spline[6] = 1.90558766317;
        kap_spline[6] = -27.7424388865;
        tkin_spline[7] = 2.22318560703;
        kap_spline[7] = -26.8137036254;
        tkin_spline[8] = 2.54078355089;
        kap_spline[8] = -25.8749225449;
        tkin_spline[9] = 2.85838149475;
        kap_spline[9] = -25.0548322235;
        tkin_spline[10] = 3.17597943861;
        kap_spline[10] = -24.4005076336;
        tkin_spline[11] = 3.49357738247;
        kap_spline[11] = -23.8952335377;
        tkin_spline[12] = 3.81117532633;
        kap_spline[12] = -23.5075651004;
        tkin_spline[13] = 4.1287732702;
        kap_spline[13] = -23.201637629;
        tkin_spline[14] = 4.44637121406;
        kap_spline[14] = -22.9593758343;
        tkin_spline[15] = 4.76396915792;
        kap_spline[15] = -22.7534867461;
        tkin_spline[16] = 5.08156710178;
        kap_spline[16] = -22.5745752086;
        tkin_spline[17] = 5.39916504564;
        kap_spline[17] = -22.4195690855;
        tkin_spline[18] = 5.7167629895;
        kap_spline[18] = -22.2833176123;
        tkin_spline[19] = 6.03436093336;
        kap_spline[19] = -22.1549519419;
        tkin_spline[20] = 6.35195887722;
        kap_spline[20] = -22.0323282988;
        tkin_spline[21] = 6.66955682109;
        kap_spline[21] = -21.9149994721;
        tkin_spline[22] = 6.98715476495;
        kap_spline[22] = -21.800121439;
        tkin_spline[23] = 7.30475270881;
        kap_spline[23] = -21.6839502137;
        tkin_spline[24] = 7.62235065267;
        kap_spline[24] = -21.5662434981;
        tkin_spline[25] = 7.93994859653;
        kap_spline[25] = -21.4473595491;
        tkin_spline[26] = 8.25754654039;
        kap_spline[26] = -21.3279560712;
        tkin_spline[27] = 8.57514448425;
        kap_spline[27] = -21.2067614838;
        tkin_spline[28] = 8.89274242811;
        kap_spline[28] = -21.0835560288;
    ...
    if (TK < tkin_spline[0]) {  // Below 1 K, just use that value
        ...
        ans = log(exp(kap_spline[KAPPA_10_NPTS_Spline - 1]) *
                  pow(exp(TK) / exp(tkin_spline[KAPPA_10_NPTS_Spline - 1]), 0.381));
    } else {  // Do spline

        tkin_spline_int = (int)floor((TK - tkin_spline[0]) * inv_BinWidth_10);

        ans = kap_spline[tkin_spline_int] +
              (TK - (tkin_spline[0] + BinWidth_10 * (float)tkin_spline_int)) *
                  (kap_spline[tkin_spline_int + 1] - kap_spline[tkin_spline_int]) * inv_BinWidth_10;
    }
...
double kappa_10_pH(double T, int flag) {
    ...
    if (flag == 1) {
        ...
        TK_spline[0] = 0.0;
        kappa_spline[0] = -21.6395565688;
        TK_spline[1] = 0.341499570777;
        kappa_spline[1] = -21.5641675629;
        TK_spline[2] = 0.682999141554;
        kappa_spline[2] = -21.5225112028;
        TK_spline[3] = 1.02449871233;
        kappa_spline[3] = -21.5130514508;
        TK_spline[4] = 1.36599828311;
        kappa_spline[4] = -21.5342522691;
        TK_spline[5] = 1.70749785389;
        kappa_spline[5] = -21.5845293039;
        TK_spline[6] = 2.04899742466;
        kappa_spline[6] = -21.6581396414;
        TK_spline[7] = 2.39049699544;
        kappa_spline[7] = -21.7420392948;
        TK_spline[8] = 2.73199656622;
        kappa_spline[8] = -21.8221380683;
        TK_spline[9] = 3.07349613699;
        kappa_spline[9] = -21.8837908896;
        TK_spline[10] = 3.41499570777;
        kappa_spline[10] = -21.9167553997;
        TK_spline[11] = 3.75649527855;
        kappa_spline[11] = -21.9200173678;
        TK_spline[12] = 4.09799484933;
        kappa_spline[12] = -21.8938574675;
        TK_spline[13] = 4.4394944201;
        kappa_spline[13] = -21.8414464728;
        TK_spline[14] = 4.78099399088;
        kappa_spline[14] = -21.7684762963;
        TK_spline[15] = 5.12249356166;
        kappa_spline[15] = -21.6796222358;
        TK_spline[16] = 5.46399313243;
        kappa_spline[16] = -21.5784701374;
        TK_spline[17] = 5.80549270321;
        kappa_spline[17] = -21.4679438133;
        TK_spline[18] = 6.14699227399;
        kappa_spline[18] = -21.3503236936;
        TK_spline[19] = 6.48849184477;
        kappa_spline[19] = -21.2277666787;
        TK_spline[20] = 6.82999141554;
        kappa_spline[20] = -21.1017425964;
        TK_spline[21] = 7.17149098632;
        kappa_spline[21] = -20.9733966978;
        TK_spline[22] = 7.5129905571;
        kappa_spline[22] = -20.8437244283;
        TK_spline[23] = 7.85449012787;
        kappa_spline[23] = -20.7135746917;
        TK_spline[24] = 8.19598969865;
        kappa_spline[24] = -20.583135408;
        TK_spline[25] = 8.53748926943;
        kappa_spline[25] = -20.4523507819;
        TK_spline[26] = 8.8789888402;
        kappa_spline[26] = -20.3215504736;
        TK_spline[27] = 9.22048841098;
        kappa_spline[27] = -20.1917429161;
        TK_spline[28] = 9.56198798176;
        kappa_spline[28] = -20.0629513946;
        TK_spline[29] = 9.90348755254;
    ...
    if (T < TK_spline[0]) {  // Below 1 K, just use that value
        ...
        // Power law extrapolation
        ans = kappa_spline[KAPPA_10_pH_NPTS_Spline - 1] +
              ((kappa_spline[KAPPA_10_pH_NPTS_Spline - 1] -
                kappa_spline[KAPPA_10_pH_NPTS_Spline - 2]) /
               (TK_spline[KAPPA_10_pH_NPTS_Spline - 1] - TK_spline[KAPPA_10_pH_NPTS_Spline - 2]) *
               (T - TK_spline[KAPPA_10_pH_NPTS_Spline - 1]));
    } else {  // Do spline

        TK_spline_int = (int)floor((T - TK_spline[0]) * inv_BinWidth_pH);

        ans = kappa_spline[TK_spline_int] +
              (T - (TK_spline[0] + BinWidth_pH * (double)TK_spline_int)) *
                  (kappa_spline[TK_spline_int + 1] - kappa_spline[TK_spline_int]) * inv_BinWidth_pH;
    }
    ans = exp(ans);
    return ans;
}
...
double kappa_10_elec(double T, int flag) {
    ...
    if (flag == 1) {
        ...
        TK_spline[0] = 0.0;
        kappa_spline[0] = -22.1549007191;
        TK_spline[1] = 0.396997429827;
        kappa_spline[1] = -21.9576919899;
        TK_spline[2] = 0.793994859653;
        kappa_spline[2] = -21.760758435;
        TK_spline[3] = 1.19099228948;
        kappa_spline[3] = -21.5641795674;
        TK_spline[4] = 1.58798971931;
        kappa_spline[4] = -21.3680349001;
        TK_spline[5] = 1.98498714913;
        kappa_spline[5] = -21.1724124486;
        TK_spline[6] = 2.38198457896;
        kappa_spline[6] = -20.9774403051;
        TK_spline[7] = 2.77898200879;
        kappa_spline[7] = -20.78327367;
        TK_spline[8] = 3.17597943861;
        kappa_spline[8] = -20.5901042551;
        TK_spline[9] = 3.57297686844;
        kappa_spline[9] = -20.3981934669;
        TK_spline[10] = 3.96997429827;
        kappa_spline[10] = -20.2078762485;
        TK_spline[11] = 4.36697172809;
        kappa_spline[11] = -20.0195787458;
        TK_spline[12] = 4.76396915792;
        kappa_spline[12] = -19.8339587914;
        TK_spline[13] = 5.16096658775;
        kappa_spline[13] = -19.6518934427;
        TK_spline[14] = 5.55796401757;
        kappa_spline[14] = -19.4745894649;
        TK_spline[15] = 5.9549614474;
        kappa_spline[15] = -19.3043925781;
        TK_spline[16] = 6.35195887722;
        kappa_spline[16] = -19.1444129787;
        TK_spline[17] = 6.74895630705;
        kappa_spline[17] = -18.9986014565;
        TK_spline[18] = 7.14595373688;
        kappa_spline[18] = -18.8720602784;
        TK_spline[19] = 7.5429511667;
        kappa_spline[19] = -18.768679825;
        TK_spline[20] = 7.93994859653;
        kappa_spline[20] = -18.6909581885;
        TK_spline[21] = 8.33694602636;
        kappa_spline[21] = -18.6387511068;
        TK_spline[22] = 8.73394345618;
        kappa_spline[22] = -18.6093755705;
        TK_spline[23] = 9.13094088601;
        kappa_spline[23] = -18.5992098958;
        TK_spline[24] = 9.52793831584;
        kappa_spline[24] = -18.6050625357;
        TK_spline[25] = 9.92493574566;
        kappa_spline[25] = -18.6319366207;
        TK_spline[26] = 10.3219331755;
        kappa_spline[26] = -18.7017996535;
        TK_spline[27] = 10.7189306053;
        kappa_spline[27] = -18.8477153986;
        TK_spline[28] = 11.1159280351;
        kappa_spline[28] = -19.0813436512;
        TK_spline[29] = 11.512925465;
    ...
    if (T < TK_spline[0]) {  // Below 1 K, just use that value
        ...
        // Power law extrapolation
        ans =
            kappa_spline[KAPPA_10_elec_NPTS_Spline - 1] +
            ((kappa_spline[KAPPA_10_elec_NPTS_Spline - 1] -
              kappa_spline[KAPPA_10_elec_NPTS_Spline - 2]) /
             (TK_spline[KAPPA_10_elec_NPTS_Spline - 1] - TK_spline[KAPPA_10_elec_NPTS_Spline - 2]) *
             (T - TK_spline[KAPPA_10_elec_NPTS_Spline - 1]));
        ...
        ans = kappa_spline[TK_spline_int] +
              (T - (TK_spline[0] + BinWidth_elec * (float)TK_spline_int)) *
                  (kappa_spline[TK_spline_int + 1] - kappa_spline[TK_spline_int]) *
                  inv_BinWidth_elec;
    }
    return exp(ans);
}
...
double Salpha_tilde(double TK, double TS, double tauGP) {
    ...
    ans =
        (1.0 - 0.0631789 * TK + 0.115995 * TK * TK - 0.401403 * TS * TK + 0.336463 * TS * TK * TK) /
...
int find_nearest_point(double min, double max, int n, double value) {
    ...
    if (value <= (min + dn))
        pos = 0;  // ensures we are in the first point
    else if (value >= max)
        pos = n - 2;  // ensures we cannot exceed the maximum point
    else
        pos = (int)floor(
            (value - min) /
            dn);  // round it down to ensure we are always either side of the cell boundary
    return pos;
}
